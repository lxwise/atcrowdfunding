  ...
  <body>
	...
	<script src="${APP_PATH}/ztree/jquery.ztree.all-3.5.min.js"></script>
        <script type="text/javascript">
			    ...
			    var setting = {
						...
						view: {
							...
							addDiyDom: function(treeId, treeNode){
								...
								if ( treeNode.icon ) {
									icoObj.removeClass("button ico_docu ico_open").addClass(treeNode.icon).css("background","");//图标
								}
	                            
							},
							addHoverDom: function(treeId, treeNode){  //鼠标移动显示
								 //   <a><span></span></a>
			...
			/* 	var zNodes =[
					{ name:"父节点1 - 展开", open:true,//open 是否打开子节点
						children: [//children子节点
							{ name:"父节点11 - 折叠",
								children: [
									{ name:"叶子节点111"},
									{ name:"叶子节点112"},
